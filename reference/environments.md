...
- For one-off analysis scripts that should be runnable from a fresh machine, use **PEP 723 inline metadata** — see `reference/commands.md`.
...
- The `uv_build` backend does not yet integrate with `uv-dynamic-versioning`. Use hatchling for now; see `reference/packaging.md`.
